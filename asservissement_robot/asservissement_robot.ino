...
/*PID*/
double consigne1 = -4, consigne2 = 4; //la consigne donne la vitesse voulue du moteur en tours/seconde
...
void loop() {
  ...
  Serial.println(String(vitesse1) + " 0 2");
  Serial.println(String(vitesse2) + " 0 2");
}
